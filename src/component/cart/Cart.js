      ...
      <img src={logo} alt="" className="object-cover object-center w-full rounded-t-md h-72 bg-gray-400" />
         <div className="flex flex-col justify-between p-6 space-y-8">
           ...
           <p className="dark:text-gray-100">Available-quiz: { total}</p>
                ...
                <Link to={`/topics/${id}`}>
                <button type="button" className="flex items-center justify-center w-full p-3 font-semibold tracking-wide  bg-gray-400 text-gray-900 hover:bg-slate-400 hover:font-bold">Start Quiz</button>      
          </Link>
       </div>          
    </div>
    );
